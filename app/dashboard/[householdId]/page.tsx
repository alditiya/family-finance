...
export default async function Dashboard({    params,
  ...
  //const household = await requireHousehold(params.householdId);
  ...
  return (
    ...
    <div className="p-6 space-y-4">
      <header className="mb-8">
        ...
        <p className="text-sm text-subtle">Ringkasan keuangan keluarga</p>
      </header>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        <TrendChart />
        <CategoryPie />
        <YearlyChart householdId={householdId} />
      </div>
      </Card>
      {/* ACTIONS */}
      <button className="w-full md:w-auto">
        <Link
          href="/dashboard/${householdId}/add"
          className="
           bg-gray-900 
           text-white    
             px-4 py-2
